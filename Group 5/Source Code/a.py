...
label1 = Label(root, text="Enter Sample code Here", font=("Times New Roman", 15, "bold"),background="pink", padx=20, pady=20)
label1.grid(row=0, column=2,padx=(110,0))


label2 = Label(root, text="Token", font=("Times New Roman", 15, "bold"),background="pink", padx=50, pady=20)
label2.grid(row=0, column=4,padx=(100,0))

entry = Text(root,font=("Times New Roman", 10, "bold"), bg="#C0C0C0",  width=50)
...
def table():
    ...
    symbol_window.configure(bg='#C0C0C0')
...
entry1 = Text(root,font=("Times New Roman", 10, "bold"), bg="#C0C0C0",  width=80)
entry1.grid(row=1, column=4, padx=(100,0))


btn1 = Button(root, text="Analyze",command=display_tokens, height=1, width=7, bg="#E6E6FA", font=("Times New Roman", 15, "bold"), relief=RIDGE, bd=9, highlightthickness=2, highlightbackground="#5e8c57")
btn1.grid(row=2, columnspan=2, column=2, ipadx=30, pady=40, padx=(50,0))

btn2 = Button(root, text="Symbol Table",command=table, height=1, width=10, bg="#E6E6FA", font=("Times New Roman", 15, "bold"), relief=RIDGE, bd=9, highlightthickness=2, highlightbackground="#5e8c57")
